import { Component, Input, Output, EventEmitter, HostBinding, ViewChild, Inject, Optional, OpaqueToken, QueryList, NgZone, Renderer2, ViewChildren } from '@angular/core';
    ...
    ListComponent.prototype.handleRowSync = function () {
        ...
        this.ngZone.runOutsideAngular(function () {
            return _this.subscriptions.add(_this.changeNotification.changes
                ...
                .merge(_this.resizeService.changes.do(function () { return _this.syncContainerHeight(); }))
